...
namespace Projekcik.Controllers
{
    public class TeamsController : Controller
    {
        ...
        {
            return View(await _context.Druzyny.ToListAsync());
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdDruzyny,IdRobota,NazwaDruzyny")] Team team)
        {
            if (id != team.IdDruzyny)
            {
                return NotFound();
            }
